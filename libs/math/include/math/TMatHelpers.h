...
#ifndef OMRE_MATH_TMATHELPERS_H_
#define OMRE_MATH_TMATHELPERS_H_
...
private:
    ...
    // error: no type named 'col_type' in 'omre::math::details::TMat44<float>'
...
#endif  // OMRE_MATH_TMATHELPERS_H_
