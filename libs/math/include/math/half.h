...
#ifndef OMRE_MATH_HALF_H_
#define OMRE_MATH_HALF_H_
...
template<> struct is_arithmetic<omre::math::half> : public std::true_type {};
...
template<> struct is_floating_point<omre::math::half> : public std::true_type {};
...
// the math::omre namespace (see above).
template<> struct is_arithmetic<omre::math::half> : public std::true_type {};

template<>
class numeric_limits<omre::math::half> {
public:
    typedef omre::math::half type;
    ...
    inline static constexpr type round_error() noexcept { return omre::math::makeHalf(0x3800); }
    inline static constexpr type min() noexcept { return omre::math::makeHalf(0x0400); }
    inline static constexpr type max() noexcept { return omre::math::makeHalf(0x7bff); }
    inline static constexpr type lowest() noexcept { return omre::math::makeHalf(0xfbff); }
    inline static constexpr type epsilon() noexcept { return omre::math::makeHalf(0x1400); }
    inline static constexpr type infinity() noexcept { return omre::math::makeHalf(0x7c00); }
    inline static constexpr type quiet_NaN() noexcept { return omre::math::makeHalf(0x7fff); }
    inline static constexpr type denorm_min() noexcept { return omre::math::makeHalf(0x0001); }
    inline static constexpr type signaling_NaN() noexcept { return omre::math::makeHalf(0x7dff); }
};

} // namespace std

#endif // OMRE_MATH_HALF_H_
