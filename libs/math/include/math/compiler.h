...
#ifndef OMRE_MATH_COMPILER_H_
#define OMRE_MATH_COMPILER_H_
...
namespace omre {
    namespace math {
        ...
        // omre::math::half, so we're forced to create our own is_arithmetic here and specialize it
        // inside of half.h.
        template<typename T>
