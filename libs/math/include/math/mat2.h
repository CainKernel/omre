...
#ifndef OMRE_MATH_MAT2_H_
#define OMRE_MATH_MAT2_H_
...
namespace std {
template<typename T>
constexpr void swap(omre::math::details::TMat22<T>& lhs,
        omre::math::details::TMat22<T>& rhs) noexcept {
    ...
    //
    //     omre::math::details::TMat22<T> t(lhs);
    //    lhs = rhs;
    //    rhs = t;
    //
