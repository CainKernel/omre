...
#ifndef OMRE_MATH_MAT4_H_
#define OMRE_MATH_MAT4_H_
...
namespace std {
template<typename T>
constexpr void swap(omre::math::details::TMat44<T>& lhs,
        omre::math::details::TMat44<T>& rhs) noexcept {
    ...
    //
    //     omre::math::details::TMat44<T> t(lhs);
    //    lhs = rhs;
    //    rhs = t;
    //
