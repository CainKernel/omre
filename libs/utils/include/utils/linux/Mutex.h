...
#ifndef OMRE_UTILS_LINUX_MUTEX_H_
#define OMRE_UTILS_LINUX_MUTEX_H_
 ...
 */
    ...
    public:
        ...
        void unlock() noexcept {
            if (UTILS_UNLIKELY(
                mState.exchange(UNLOCKED, std::memory_order_release) == LOCKED_CONTENDED)) {
                wake();
            }
        }
...
#endif // OMRE_UTILS_LINUX_MUTEX_H_
