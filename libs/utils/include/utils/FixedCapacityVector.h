...
#ifndef OMRE_UTILS_FIXEDCAPACITYVECTOR_H_
#define OMRE_UTILS_FIXEDCAPACITYVECTOR_H_
...
#ifndef NDEBUG
#define OMRE_FORCE_CAPACITY_CHECK true
#else
#define OMRE_FORCE_CAPACITY_CHECK false
#endif
...
private:
    ...
    iterator assertCapacityForSize(size_type s) {
        if constexpr(CapacityCheck || OMRE_FORCE_CAPACITY_CHECK) {
...
#endif // OMRE_UTILS_FIXEDCAPACITYVECTOR_H_
