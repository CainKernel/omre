 ...
 */
#ifndef OMRE_UTILS_JNIHELP_H
#define OMRE_UTILS_JNIHELP_H
...
inline jstring jniCreateUTFString(JNIEnv *env, const char *data) {
    return jniCreateUTFString(&env->functions, data);
}
