...
#ifndef OMRE_UTILS_COMPRESSED_PAIR_H_
#define OMRE_UTILS_COMPRESSED_PAIR_H_
...
namespace utils {
    ...
    struct compressed_pair : private T1, private T2 {
        ...
        std::enable_if_t<
            ...
            dependent_type<std::is_default_constructible < T2>, Dummy
        >::value>>
...
#endif // OMRE_UTILS_COMPRESSED_PAIR_H_
