...
#ifndef OMRE_UTILS_SYSTRACE_H_
#define OMRE_UTILS_SYSTRACE_H_


#define SYSTRACE_TAG_NEVER          (0)
#define SYSTRACE_TAG_ALWAYS         (1<<0)
#define SYSTRACE_TAG_OMRE            (1<<1)  // don't change, used in makefiles
