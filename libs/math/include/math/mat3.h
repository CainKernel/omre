...
#ifndef OMRE_MATH_MAT3_H_
#define OMRE_MATH_MAT3_H_
...
namespace std {
template<typename T>
constexpr void swap(omre::math::details::TMat33<T>& lhs,
        omre::math::details::TMat33<T>& rhs) noexcept {
    ...
    //
    //     omre::math::details::TMat33<T> t(lhs);
    //    lhs = rhs;
    //    rhs = t;
    //
